  ...
  LifeEvent(
    ...
    choices: [
      EventChoice(
        ...
        effect: EventEffect(cash: -18, stress: 1),
      ),
    ],
  ),
  LifeEvent(
  ...
  LifeEvent(
    ...
    choices: [
      EventChoice(
        ...
        effect: EventEffect(cash: 15, happiness: 1),
      ),
    ],
  ),
  LifeEvent(
  ...
  LifeEvent(
    ...
    choices: [
      EventChoice(
        ...
        effect: EventEffect(cash: 22, stress: 2, reliability: 1),
      ),
      EventChoice(
        id: 'skip',
        label: 'Skip it',
  ...
  LifeEvent(
    ...
    choices: [
      EventChoice(
        ...
        effect: EventEffect(cash: 28, happiness: 1),
      ),
    ],
  ),
  LifeEvent(
